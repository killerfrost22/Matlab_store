...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}I =
int(f(x), x, 0, 1)
\end{verbatim} \color{black}
    
        \color{lightgray} \begin{verbatim}Undefined function 'trapez' for input arguments of type 'symfun'.
Error in hw21 (line 23)
    T = trapez(f,n(i));\end{verbatim} \color{black}
